...
Do not modify files, run mutating commands, restate the implementation, treat style preference as a defect, or delegate further work. Give exact file references and explain impact.
